...
class Lay_Out_107(models.Model):
    ...
    vendas_a_vista = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    compras_a_vista = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    opcoes_de_compra = models.DecimalField(
        max_digits=13, decimal_places=2, blank=True, null=True)
    opcoes_de_venda = models.DecimalField(
        max_digits=13, decimal_places=2, blank=True, null=True)
    outras_operacoes = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    valor_liquido_das_operacoes = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    taxas = models.DecimalField(max_digits=13, decimal_places=2, null=True)
    emolumentos = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    corretagem_liquida = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    corretagem_bruta = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    valor_liquido_da_nota = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
...
class Lay_Out_108(models.Model):
    ...
    preco_da_liquidacao = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
    valor_da_operacao = models.DecimalField(
        max_digits=13, decimal_places=2, null=True)
...
class Notcor(models.Model):
    ...
    natope = models.CharField(
        max_length=1, choices=NATOPE_CHOICES, blank=False, null=False)
